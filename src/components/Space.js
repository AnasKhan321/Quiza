  ...
  return (
    <>
      ...
      <div className="buttons flex absolute bottom-0  justify-between w-9/12  mx-auto   " style={style3}>
        <button className=" bg-gradient-to-r from-yellow-400 to-red-200   py-2 text-white px-4 rounded-md opacity-0   border "> &lt;  Previouse  </button>
        <button disabled={disable3} className=" bg-gradient-to-r from-yellow-400 to-red-200   py-2 text-white px-4 rounded-md   border " onClick={handleClick} >Next &gt;</button>
